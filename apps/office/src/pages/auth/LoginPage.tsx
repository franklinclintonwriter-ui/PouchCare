    ...
    <div className="min-h-screen bg-midnight flex items-center justify-center p-6">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-sky-500 to-indigo-500 flex items-center justify-center font-sora font-bold text-xl text-white mx-auto mb-4 shadow-lg">P</div>
          <h1 className="font-sora text-xl font-bold">Staff Office</h1>
          <p className="text-sm text-text-muted mt-1">office.pouchcare.com.bd</p>
        </div>
        ...
        <p className="text-xs text-center text-text-muted mt-4">
          Management access? <a href="https://m.pouchcare.com" className="text-sky-500 hover:underline">m.pouchcare.com ↗</a>
        </p>
      </div>
    </div>
  )
