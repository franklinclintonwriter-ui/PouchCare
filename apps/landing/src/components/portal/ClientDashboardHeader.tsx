              ...
              {notifOpen && (
                ...
                <div className="flex items-center justify-between border-b border-gray-100/80 px-3 pb-2 dark:border-gray-800">
                  ...
                  {unread > 0 && (
                    <button
                      ...
                      className="rounded-md px-1.5 py-0.5 text-[11px] font-medium text-primary-600 dark:text-primary-400 transition-colors duration-200 hover:bg-primary-50 dark:hover:bg-primary-950/40 hover:text-primary-800 dark:hover:text-primary-300"
                    >
                      Clear
                    </button>
                  )}
                ...
                {items.length > 0 && (
                  <Link
                    ...
                    onClick={() => setNotifOpen(false)}
                    className="block border-t border-gray-100/80 dark:border-gray-800 px-3 py-2 text-center text-xs font-medium text-primary-600 dark:text-primary-400 transition-colors duration-200 hover:bg-primary-50/50 dark:hover:bg-primary-950/30"
                  >
