...
const ForgotPasswordPage = lazy(
  () => import("@/pages/portal/ForgotPasswordPage"),
);
const ResetPasswordPage = lazy(
  () => import("@/pages/portal/ResetPasswordPage"),
);
...
const ServicesCatalogPage = lazy(
  () => import("@/pages/dashboard/ServicesPage"),
);
        ...
        <Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            <Route element={<MarketingLayout />}>
              ...
              <Route
                path="/services/hosting/search"
                element={<DomainSearchPage />}
              />
              <Route
                path="/services/hosting"
                element={<ServicesHostingPage />}
              />
              <Route
                path="/services/web-to-apk"
                element={<ServicesWebToApkPage />}
              />
