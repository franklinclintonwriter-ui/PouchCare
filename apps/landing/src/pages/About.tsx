...
const FOUNDER_SCHEMA = {
  ...
  /* ── Recognition ── */
  award: ["South Asia's Marketing Pioneer", "Award-Winning SEO Expert"],
...
const VALUES = [
  {
    ...
    description:
      "Every strategy decision is driven by one question: will this move the needle for our clients? Vanity metrics have no place here.",
  },
  {
    icon: Heart,
    title: "Client-first always",
    description:
      "We treat every client like a partner, not a ticket. Your success is our success — and we mean that literally.",
  },
  {
    icon: Users,
    title: "Transparency at scale",
    description:
      "Live dashboards, weekly standups, direct Slack access. No black boxes, no hiding behind jargon.",
  },
  {
    icon: Globe,
    title: "Global thinking",
    description:
      "With offices across three continents and clients in 30+ countries, we understand nuanced, international SEO.",
  },
];
...
const MEDIA_FEATURES = [
  {
    name: "India.com",
    url: "https://www.india.com/money/abdullah-babu-the-seo-genius-transforming-digital-marketing-in-asia-7866495/",
  },
  {
    name: "Republic World",
    url: "https://www.republicworld.com/initiatives/abdullah-babu-an-seo-strategist-with-a-practical-approach-to-digital-marketing",
  },
  {
    name: "Free Press Journal",
    url: "https://www.freepressjournal.in/latest-news/abdullah-al-mamun-the-seo-visionary-from-asia-empowering-global-digital-growth",
  },
  {
    name: "Silicon India",
    url: "https://www.siliconindia.com/news/general/abdullah-babu-building-digital-growth-through-simplicity-and-strategy-nid-236632-cid-1.html",
  },
  {
    name: "The Hans India",
    url: "https://www.thehansindia.com/news/business/redefining-digital-growth-with-vision-and-integrity-in-asia-986908",
  },
  {
    name: "ABP Live",
    url: "https://news.abplive.com/brand-wire/abdullah-al-mamun-babu-the-seo-expert-and-digital-entrepreneur-changing-asia-s-online-world-1796913",
  },
];
...
export default function About() {
  return (
    <>
        ...
        <div className="container-max px-4 sm:px-6 lg:px-8 text-center">
          <ScrollReveal>
            ...
            <SectionHeading className="mb-4">
              Built by an SEO visionary,{" "}
              <span className="text-gradient">for real results</span>
            </SectionHeading>
            <SectionSub className="max-w-xl mx-auto">
              PouchCare was born from a second-hand laptop in Bangladesh. Today
            ...
            <ScrollReveal direction="left">
              <div>
                ...
                <div className="space-y-4 leading-relaxed text-gray-600">
                  <p>
                    <strong className="text-gray-900">Abdullah Al Mamun</strong>
                    , also known as{" "}
                    <strong className="text-gray-900">Abdullah Babu</strong>, is
                    a{" "}
                    <strong className="text-gray-900">
                      Bangladeshi Entrepreneur and Digital Strategist
                    </strong>{" "}
                    based in Dubai. He is the founder of{" "}
                    <strong className="text-gray-900">AAWS</strong> and{" "}
                    <strong className="text-gray-900">PouchCare</strong>. Babu
                  ...
                  <p>
                    With 10+ years in digital marketing, Abdullah is widely
                    recognised as an award-winning SEO expert and{" "}
                    <strong className="text-gray-900">
                      South Asia's Marketing Pioneer
                    </strong>
                    . His journey began with a second-hand laptop and a slow
                    internet connection in Bangladesh — through relentless
                    self-learning he mastered SEO, content marketing, affiliate
                    strategy, Google penalty recovery, and web monetisation.
                  </p>
                  <p>
                    PouchCare is the agency he built to solve the problem he
                    kept seeing: great businesses struggling to be found online
                    while lesser competitors dominated search results. Today the
                    agency serves 500+ clients across 30+ countries from 5
                    global offices, with Abdullah leading strategy from Dubai,
                    UAE.
                  </p>
                </div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {MEDIA_FEATURES.map((m) => (
                      <a
                        ...
                        className="inline-flex items-center gap-1 rounded-lg border border-gray-300 px-2.5 py-1 text-xs text-gray-600 transition-colors hover:border-primary-300 hover:text-primary-700"
                      >
                        {m.name}
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group mt-6 inline-flex items-center gap-2 text-sm font-medium text-primary-600 transition-colors hover:text-primary-700"
                >
            ...
            <ScrollReveal direction="right">
              <div className="grid grid-cols-2 gap-4">
                {STATS.map((s, i) => (
                  <div
                    key={s.label}
                    className={`glass-card p-6 text-center ${i === 1 ? "mt-6" : i === 3 ? "-mt-6" : ""}`}
                  >
                    <div className="mb-2 font-sora text-4xl font-bold text-gray-900">
            ...
            {VALUES.map((v, i) => {
              ...
              return (
                <ScrollReveal key={v.title} delay={i * 80}>
                  <div className="group rounded-2xl border border-gray-200 bg-white p-6 transition-colors hover:border-primary-300">
        ...
        <div className="container-max">
          <div className="text-center mb-12">
            <ScrollReveal>
              ...
              <SectionHeading>
                The people behind{" "}
                <span className="text-gradient">your results</span>
              </SectionHeading>
            </ScrollReveal>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {TEAM.map((member, i) => (
              <ScrollReveal key={member.name} delay={i * 80}>
                <div
                  className={`glass-card p-6 flex items-start gap-4 group hover:border-sky-500/30 transition-all ${i === 0 ? "lg:col-span-1 border-sky-500/20 bg-sky-500/5" : ""}`}
                >
                  <div
                    className={`w-12 h-12 rounded-xl flex items-center justify-center text-sky-400 font-bold font-sora text-lg shrink-0 border ${i === 0 ? "bg-gradient-to-br from-sky-500/30 to-indigo-500/30 border-sky-500/40" : "bg-gradient-to-br from-sky-500/20 to-indigo-500/20 border-sky-500/20"}`}
                  >
                    {member.avatar}
                  </div>
                  <div>
                    <h3
                      className={`font-semibold transition-colors group-hover:text-primary-700 ${i === 0 ? "text-primary-700" : "text-gray-900"}`}
                    >
                      {member.name}
                    </h3>
                    <p className="text-sky-400 text-xs font-medium mb-2">
                      {member.role}
                    </p>
                    <p className="text-sm leading-relaxed text-gray-600">
                      {member.bio}
      ...
      {/* Milestones timeline */}
      <section className="section-pad bg-gray-50 px-4 sm:px-6 lg:px-8">
        <div className="container-max">
          <div className="text-center mb-10">
            <ScrollReveal>
              ...
              <p className="mx-auto max-w-xl text-sm leading-relaxed text-gray-600">
                From a one-person freelance operation with a slow internet
                connection in Bangladesh to a global agency with 60+ specialists
                across 5 offices — here is the PouchCare story.
              </p>
            </ScrollReveal>
          </div>
            ...
            <div className="space-y-6">
              {[
                ...
                <ScrollReveal key={m.year} delay={i * 80}>
                  <div
                    className={`flex items-start gap-5 sm:gap-8 ${i % 2 === 0 ? "sm:flex-row" : "sm:flex-row-reverse"}`}
                  >
                    <div className="group flex-1 rounded-2xl border border-gray-200 bg-white p-5 shadow-soft transition-all hover:border-primary-300">
                      <div className="text-sky-400 font-mono font-bold text-sm mb-1">
                        {m.year}
                      </div>
                      <h3 className="mb-2 font-sora font-semibold text-gray-900 transition-colors group-hover:text-primary-700">
                        {m.title}
                      </h3>
                      <p className="text-sm leading-relaxed text-gray-600">
                        {m.desc}
            ...
            <div className="rounded-2xl border border-navy-600/60 bg-navy-800/50 p-7 sm:p-8">
              <div className="text-center mb-8">
                ...
                <p className="text-slate-400 text-sm max-w-lg mx-auto leading-relaxed">
                  We do not pursue awards for the sake of it. But when our
                  clients&apos; results speak for themselves, the industry takes
                  notice.
                </p>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                {[
                  {
                    icon: Award,
                    title: "Top 50 Link Building Agency",
                    sub: "Clutch.co · 2024",
                  },
                  {
                    icon: TrendingUp,
                    title: "South Asia's Marketing Pioneer",
                    sub: "Abdullah Babu · Recognised industry-wide",
                  },
                  {
                    icon: CheckCircle,
                    title: "4.9/5 Average Client Rating",
                    sub: "Based on 200+ verified reviews",
                  },
                  {
                    icon: Zap,
                    title: "Google Partner Certified",
                    sub: "Ads management team",
                  },
                ].map(({ icon: Icon, title, sub }) => (
                  <div
                    key={title}
                    className="text-center p-5 rounded-xl border border-navy-600/40 bg-navy-700/20 hover:border-sky-500/20 transition-colors group"
                  >
        ...
        <div className="container-max text-center">
          <ScrollReveal>
            ...
            <SectionSub className="max-w-lg mx-auto mb-10">
              Book a free 30-minute strategy call and let us show you exactly
              how we will grow your organic traffic.
            </SectionSub>
