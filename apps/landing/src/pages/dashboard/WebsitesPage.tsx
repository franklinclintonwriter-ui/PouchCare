 ...
 * Route: /dashboard/websites — `/v1/portal/websites`, not staff `/v1/assets/websites`.
 */
...
export default function WebsitesPage() {
  ...
  return (
    <div className="space-y-5 sm:space-y-6">
      ...
      <Sheet
        isOpen={showAddForm}
        onClose={createMutation.isPending ? () => {} : closeAddWebsite}
        title="Add website"
        description="Add a new site to monitor uptime, SEO, and SSL."
      ...
      >
        <form id="add-website-form" onSubmit={handleAddWebsite} className="space-y-4" noValidate>
          <div>
              ...
              <div className="flex items-start justify-between gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center rounded-lg border border-red-200 bg-red-50/50 p-1.5 text-red-500 transition-colors hover:border-red-300 hover:bg-red-50 hover:text-red-700 dark:border-red-900/40 dark:bg-red-900/10 dark:text-red-400 dark:hover:bg-red-900/30 dark:hover:text-red-300"
