...
import { DomainSearchWidget } from "@/components/ui/DomainSearchWidget";
import {
  SectionLabel,
  SectionHeading,
  SectionSub,
  ...
  return (
    <section className="relative overflow-hidden bg-white py-16 sm:py-20">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0">
        <div className="absolute -top-24 left-1/2 h-[500px] w-[800px] -translate-x-1/2 rounded-full bg-primary-50 opacity-70 blur-[100px]" />
        <div className="absolute -bottom-16 right-0 h-[350px] w-[400px] rounded-full bg-violet-50 opacity-60 blur-[80px]" />
      </div>
      {/* Dot grid */}
      <div
        aria-hidden
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollReveal>
          ...
          <div className="text-center mb-10">
            <span className="inline-flex items-center gap-1.5 rounded-full border border-primary-200 bg-primary-50 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-primary-700 mb-4">
              <Globe className="h-3.5 w-3.5 text-primary-500" aria-hidden />
              Domain Registration
            </span>
            <h2 className="font-sora text-2xl font-extrabold tracking-tight text-gray-900 sm:text-3xl lg:text-4xl">
              Find &amp; claim your{" "}
              <span
                style={{
          ...
          <div className="mx-auto max-w-2xl">
            <DomainSearchWidget inline={false} />
          </div>
