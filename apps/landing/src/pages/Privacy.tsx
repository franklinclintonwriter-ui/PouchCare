            ...
            <ScrollReveal>
              <div className="glass-card p-6 sm:p-7 mb-8">
                <p className="text-slate-400 text-sm leading-relaxed mb-4">
                  ...
                  PouchCare collects, why we collect it, how we use it, and your rights regarding that data.
                  We are committed to handling your information responsibly and in compliance with
                  applicable data protection laws, including GDPR (EU/UK) and applicable UAE regulations.
                </p>
                <p className="text-slate-400 text-sm leading-relaxed mb-4">
                  This policy applies to all personal data collected through PouchCare.com, our client
                  portal, email communications, and any other interaction you have with PouchCare
                  Digital Services. &quot;Personal data&quot; means any information that identifies you or
                  could be used to identify you as an individual.
                </p>
                <p className="text-slate-400 text-sm leading-relaxed">
                  We do not sell, rent, or trade your personal data to third parties for their marketing
                  purposes — ever. If you have any questions or wish to exercise your data rights,
                  please contact our Data Protection contact at{' '}
                  <a href="mailto:privacy@pouchcare.com" className="text-sky-400 hover:underline">privacy@pouchcare.com</a>.
                  We will respond to all requests within 72 hours. Last updated: {LAST_UPDATED}.
                </p>
              </div>
            </ScrollReveal>
