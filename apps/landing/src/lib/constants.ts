...
export const SERVICES: ServiceItem[] = [
  { icon: '🔍', name: 'On-Page SEO', price: 'from $200', category: 'SEO', description: 'Full technical audit, keyword mapping, and on-page optimization for maximum rankings.' },
  { icon: '🔗', name: 'Link Building', price: 'from $15/link', category: 'SEO', description: 'High-authority guest posts and niche edits that move the needle on your domain authority.' },
  { icon: '⚙️', name: 'Technical SEO', price: 'from $300', category: 'SEO', description: 'Core Web Vitals, crawlability, schema markup and site architecture improvements.' },
  { icon: '📍', name: 'Local SEO', price: 'from $150', category: 'SEO', description: 'Google Business Profile optimization and local citation building for brick-and-mortar.' },
  { icon: '💻', name: 'Web Development', price: 'from $299', category: 'Dev', description: 'Fast, modern websites and web apps built with React, Next.js, and WordPress.' },
  { icon: '📱', name: 'App Development', price: 'from $999', category: 'Dev', description: 'Cross-platform mobile apps built with React Native for iOS and Android.' },
  { icon: '🛒', name: 'E-commerce Dev', price: 'from $599', category: 'Dev', description: 'High-converting Shopify, WooCommerce, and custom e-commerce solutions.' },
  { icon: '🔧', name: 'WordPress Dev', price: 'from $199', category: 'Dev', description: 'Custom themes, plugins, and performance optimization for WordPress sites.' },
  { icon: '🎨', name: 'UI/UX Design', price: 'from $49', category: 'Design', description: 'Beautiful, conversion-focused designs in Figma for web and mobile.' },
  { icon: '🎬', name: 'Video Editing', price: 'from $79', category: 'Design', description: 'Professional video editing for YouTube, social media, and ads.' },
  { icon: '📝', name: 'Content Writing', price: 'from $25/article', category: 'Content', description: 'SEO-optimized blog posts, web copy, and product descriptions by native writers.' },
  { icon: '✏️', name: 'Copywriting', price: 'from $35', category: 'Content', description: 'High-converting sales pages, email sequences, and ad copy that drives action.' },
  { icon: '📣', name: 'Google Ads', price: 'from $200/mo', category: 'Ads', description: 'ROI-focused PPC campaigns managed by certified Google Ads specialists.' },
  { icon: '📘', name: 'Facebook Ads', price: 'from $150/mo', category: 'Ads', description: 'Profitable Meta advertising across Facebook and Instagram audiences.' },
];
...
export const BACKLINK_PACKAGES: BacklinkPackage[] = [
  { name: 'Starter GP', da: 'DA 20-30', type: 'Guest Post', perLink: '$15', x10: '$130', x50: '$600', x100: '$1,100', x1000: '$9,500' },
  { name: 'Standard GP', da: 'DA 30-40', type: 'Guest Post', perLink: '$30', x10: '$265', x50: '$1,300', x100: '$2,400', x1000: '$22,000', isPopular: true },
  { name: 'Premium GP', da: 'DA 50+', type: 'Guest Post', perLink: '$80', x10: '$720', x50: '$3,600', x100: '$6,800', x1000: '$65,000' },
  { name: 'Niche Edit', da: 'DA 30-40', type: 'Niche Edit', perLink: '$25', x10: '$220', x50: '$1,050', x100: '$1,950', x1000: '$18,000' },
  { name: 'Bulk Mixed', da: 'Mixed', type: 'Mixed', perLink: '$10', x10: '$88', x50: '$420', x100: '$800', x1000: '$7,500', isBestValue: true },
  { name: 'Web 2.0', da: 'N/A', type: 'Web 2.0', perLink: '$2', x10: '$17', x50: '$80', x100: '$150', x1000: '$1,200' },
  { name: 'Forum Profile', da: 'N/A', type: 'Profile', perLink: '$0.50', x10: '$4', x50: '$18', x100: '$35', x1000: '$280' },
];
...
export const TESTIMONIALS: Testimonial[] = [
  {
    ...
    quote: "PouchCare's guest post quality is exceptional. DA 40+ placements at these prices — nowhere else comes close. We've white-labeled their service for three years running.",
    rating: 5,
  },
  {
    name: 'Fatima Ahmed',
    ...
    quote: 'Organic traffic tripled in 4 months. The SEO retainer is the best investment we have made this year. The team is responsive, transparent, and actually delivers.',
    rating: 5,
  },
  {
    name: 'Raj Mehta',
    flag: '🇺🇸',
    role: 'SaaS CEO',
    quote: 'Deep technical knowledge, transparent reporting, and they actually communicate. Rare in this industry. Our domain authority went from 22 to 51 in 8 months.',
    rating: 5,
  },
  {
    name: 'Sofia Reyes',
    ...
    quote: 'The backlink packages have the best ROI we have seen. We scaled from 10 links/month to 100+ with zero quality drop. PouchCare is our go-to link building partner.',
    rating: 5,
  },
  {
    ...
    quote: 'Ranked our competitive keywords in 6 months. The team understands Dubai market nuances. Exceptional professionalism from day one.',
    rating: 5,
  },
];
...
export const TEAM: TeamMember[] = [
  ...
  { name: 'Nadia Chowdhury', role: 'Head of SEO', avatar: 'N', bio: 'Former Google Ads specialist. Leads technical SEO strategy across 200+ client campaigns.' },
  { name: 'Omar Sheikh', role: 'Link Building Lead', avatar: 'O', bio: 'Manages our global network of 5,000+ publisher relationships and guest post inventory.' },
  { name: 'Priya Singh', role: 'Dev Team Lead', avatar: 'P', bio: 'Full-stack engineer specialising in WordPress, React, and performance optimisation.' },
  { name: 'Zaid Al-Hassan', role: 'Operations Manager', avatar: 'Z', bio: 'Coordinates delivery across our offices in Dubai, London, Dhaka, Karachi, and Lahore.' },
  { name: 'Emma Clarke', role: 'Client Success', avatar: 'E', bio: 'Ensures every client achieves measurable growth with weekly check-ins and detailed reporting.' },
];
...
export const WHY_US = [
  {
    ...
    description: 'We measure success by your rankings and revenue, not just deliverables. Every strategy is built around your specific goals.',
  },
  {
    icon: '🔒',
    title: 'White-Hat Only',
    description: 'No PBNs, no shortcuts. Every link we build and every SEO tactic we use is 100% compliant with Google guidelines.',
  },
  {
    icon: '📊',
    title: 'Full Transparency',
    description: 'Live dashboards, weekly reports, and direct Slack access to your account manager. You always know what is happening.',
  },
  {
    icon: '⚡',
    title: 'Fast Turnaround',
    description: 'Guest posts go live within 5-7 days. SEO changes are implemented within 48 hours. No waiting weeks for results.',
  },
  {
    icon: '🌍',
    title: 'Global Network',
    description: 'Access to 5,000+ publisher sites across every niche, in every language. Your perfect link is already in our inventory.',
  },
  {
    icon: '💰',
    title: 'Best Price Guarantee',
    description: 'Found lower prices for the same quality? We will beat it. Premium SEO does not have to cost a fortune.',
  },
];
...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    excerpt: 'Guest posts, niche edits, digital PR — we break down which tactics are moving the needle right now and which ones to avoid entirely.',
  ...
  },
  {
    ...
    excerpt: 'A behind-the-scenes case study: the exact technical fixes, content gaps we filled, and the 42-link building campaign that tripled organic revenue in just 3 months.',
    category: 'Case Study',
  ...
  },
  {
    ...
    excerpt: 'Building links to a broken site is like pouring water into a leaky bucket. Run through our 47-point technical audit first and watch every link work twice as hard.',
  ...
  {
    title: 'The Complete On-Page SEO Guide for 2025: Rank Higher Without More Links',
    excerpt: 'Master the on-page fundamentals that Google rewards in 2025 — from title tag formulas and content structure to E-E-A-T signals that build lasting authority.',
  ...
  {
    title: 'Google Ads vs SEO in 2025: When to Use Each (And Why You Need Both)',
    excerpt: 'Paid search delivers instant traffic; SEO builds compounding organic assets. Here is our data-driven framework for deciding how to split your budget between the two.',
    category: 'Paid Ads',
    readTime: '9 min read',
    date: 'Jan 22, 2025',
  ...
  },
  {
    ...
    excerpt: 'From Google Business Profile optimisation to local citations and review strategies — everything a brick-and-mortar business needs to own the local pack.',
    category: 'Local SEO',
  ...
  {
    title: 'Content Writing for SEO: How to Create Articles That Rank and Convert',
    excerpt: 'Great SEO content is not about keyword density or word counts. Here is the framework our content team uses to write articles that rank on page 1 and drive enquiries.',
    category: 'Content',
    readTime: '10 min read',
    date: 'Dec 15, 2024',
  ...
  {
    title: 'Web Development and SEO: Why Your Site Architecture Determines Your Rankings',
    excerpt: 'How your site is built has a direct impact on how well it ranks. Here is what every business owner needs to know about technical architecture, Core Web Vitals, and performance.',
