export const ROUTES = {
  ...
  RECRUITMENT_ANALYTICS: "/hr/analytics",

  // Assets — PouchCare INTERNAL inventory only (staff `/v1/assets/*`). Not client portal hosting.
  ASSETS: "/assets",
  ...
  // Tools (SEO / web utilities — backend /v1/tools/*)
  TOOLS: "/tools",
  ...
  TOOLS_SERP_RANK_CHECK: "/tools/serp-rank-check",

  // AI Assistant (backend /v1/ai/*)
  AI: "/ai",
  AI_CHAT: "/ai/chat",
  AI_BLOG: "/ai/blog",
  AI_SEO_BRIEF: "/ai/seo-brief",
  AI_TASK_PLANNER: "/ai/task-planner",
  AI_REPORT: "/ai/report",
  AI_USAGE: "/ai/usage",
