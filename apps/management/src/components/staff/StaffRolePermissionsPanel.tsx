...
import { PERMISSION_KEYS, PERMISSION_LABELS } from '@/constants/permissionKeys';
    ...
    <Card>
      ...
      <CardContent className="grid gap-3 sm:grid-cols-2">
        {PERMISSION_KEYS.map((key) => (
          ...
          >
            <span className="text-sm text-gray-700 dark:text-gray-200">{PERMISSION_LABELS[key]}</span>
