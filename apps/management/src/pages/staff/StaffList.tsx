...
export default function StaffList() {
  ...
  const [confirmRestore, setConfirmRestore] = useState<StaffMember | null>(
    null,
  );
  ...
  const columns: Column<StaffMember>[] = [
    ...
    },
    {
      ...
      render: (row) => (
        <Badge
          variant={roleBadgeVariant[row.systemRole] ?? "default"}
          size="sm"
        >
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="mt-4 flex flex-wrap items-center gap-2 border-t border-gray-100 pt-4 dark:border-gray-700/60">
                          <Badge
                            variant={
                              roleBadgeVariant[m.systemRole] ?? "default"
                            }
                            size="sm"
                          >
              ...
              <Button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    toast.error(
                      getApiErrorMessage(err, "Failed to create staff"),
                    );
                  }
                }}
              >
        ...
        <ConfirmDialog
          ...
          onConfirm={async () => {
            ...
            try {
              ...
              toast.error(
                getApiErrorMessage(err, "Failed to deactivate staff"),
              );
            }
          }}
        />
