/**
 * Staff dashboard: PouchCare **internal** domain portfolio (company-owned / ops inventory).
 * Not the client portal "My domains" UI — that lives on the landing app + `/v1/portal/hosting/*`.
 */
