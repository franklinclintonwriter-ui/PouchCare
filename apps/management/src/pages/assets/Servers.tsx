/**
 * Staff dashboard: PouchCare **internal** server / hosting asset list (company infrastructure).
 * unrelated to client-facing portal flows (portal members do not use this screen).
 */
