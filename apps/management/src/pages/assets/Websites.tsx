/**
 * Staff dashboard: PouchCare **internal** website inventory (company projects / infrastructure).
 * Not the client portal "My websites" — that uses `/v1/portal/websites` from the landing app.
 */
      ...
      >
        <div className="space-y-3">
          ...
          <Input
            ...
            value={form.hostedOn}
            onChange={(e) =>
              setForm((f) => ({ ...f, hostedOn: e.target.value }))
            }
          />
          <Input
            label="Domain Linked"
            value={form.domainLinked}
            onChange={(e) =>
              setForm((f) => ({ ...f, domainLinked: e.target.value }))
            }
          />
          <Input
            type="number"
